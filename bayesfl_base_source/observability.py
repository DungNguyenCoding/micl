...
METRICS_FIELDS: List[str] = [
    ...
    "sparse_comm_enabled", "sparse_metric", "sparse_selection_method", "sparse_ratio", "sparse_warmup_rounds", "sparse_min_keep",
    ...
    "sparse_selection_score_mean_mean", "sparse_selection_score_p50_mean", "sparse_selection_score_p90_mean",
    "sparse_selected_score_mean_mean", "sparse_selected_score_p50_mean", "sparse_selected_score_p90_mean",
    "sparse_dropped_score_mean_mean", "sparse_dropped_score_p50_mean", "sparse_dropped_score_p90_mean",
    "sparse_sent_update_fraction_l2_mean", "sparse_dropped_update_fraction_l2_mean", "sparse_update_energy_retention_mean",
    "sparse_dense_bytes_mean", "sparse_sent_bytes_mean", "sparse_byte_saving_ratio_mean",
    ...
    "communication_cumulative_dense_bytes", "communication_cumulative_sparse_bytes", "communication_cumulative_saving_ratio",
...
CLIENT_TRAIN_FIELDS = [
    ...
    "sparse_comm_enabled", "sparse_metric", "sparse_selection_method", "sparse_ratio", "sparse_warmup_rounds", "sparse_num_params_total", "sparse_num_params_sent",
    "sparse_compression_ratio", "sparse_threshold", "sparse_score_mean", "sparse_score_p50", "sparse_score_p90",
    "sparse_selection_score_mean", "sparse_selection_score_p50", "sparse_selection_score_p90",
    "sparse_selected_score_mean", "sparse_selected_score_p50", "sparse_selected_score_p90",
    "sparse_dropped_score_mean", "sparse_dropped_score_p50", "sparse_dropped_score_p90",
    "sparse_selected_selection_score_mean", "sparse_selected_selection_score_p50", "sparse_selected_selection_score_p90",
    "sparse_dropped_selection_score_mean", "sparse_dropped_selection_score_p50", "sparse_dropped_selection_score_p90",
    "sparse_sent_update_l2", "sparse_dropped_update_l2", "sparse_sent_update_fraction_l2", "sparse_dropped_update_fraction_l2", "sparse_update_energy_retention",
    "sparse_dense_bytes", "sparse_sent_bytes", "sparse_index_bytes", "sparse_value_bytes", "sparse_byte_saving_ratio",
...
SPARSE_COMM_FIELDS = [
    ...
    "sparse_comm_enabled", "sparse_metric", "sparse_selection_method", "sparse_ratio", "sparse_warmup_rounds",
...
def base_round_row(cfg: RunConfig, run_id: str, round_idx: int) -> Dict[str, Any]:
    return {
        ...
        "sparse_selection_method": str(getattr(cfg, "sparse_selection", "bayesian")),
...
def summarize_client_rows(rows: Sequence[Mapping[str, Any]]) -> Dict[str, Any]:
    ...
    for key, out_prefix in [
        ...
        ("sparse_selection_score_mean", "sparse_selection_score_mean"),
        ("sparse_selection_score_p50", "sparse_selection_score_p50"),
        ("sparse_selection_score_p90", "sparse_selection_score_p90"),
        ("sparse_selected_score_mean", "sparse_selected_score_mean"),
        ("sparse_selected_score_p50", "sparse_selected_score_p50"),
        ("sparse_selected_score_p90", "sparse_selected_score_p90"),
        ("sparse_dropped_score_mean", "sparse_dropped_score_mean"),
        ("sparse_dropped_score_p50", "sparse_dropped_score_p50"),
        ("sparse_dropped_score_p90", "sparse_dropped_score_p90"),
        ("sparse_sent_update_fraction_l2", "sparse_sent_update_fraction_l2"),
        ("sparse_dropped_update_fraction_l2", "sparse_dropped_update_fraction_l2"),
        ("sparse_update_energy_retention", "sparse_update_energy_retention"),
        ("sparse_dense_bytes", "sparse_dense_bytes"),
        ("sparse_sent_bytes", "sparse_sent_bytes"),
        ("sparse_byte_saving_ratio", "sparse_byte_saving_ratio"),
    ]:
        arr = values(key)
        if arr.size:
